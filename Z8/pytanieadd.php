...
$sql = "INSERT INTO pytania(idt, tresc_pytania, odpowiedz_a, odpowiedz_b, odpowiedz_c, odpowiedz_d, poprawna, file_name, file_Ext) 
VALUES('$idt', '$tresc_pytania', '$odp_a', '$odp_b', '$odp_c', '$odp_d', '$poprawna', '$file_name', '$file_extension')";
