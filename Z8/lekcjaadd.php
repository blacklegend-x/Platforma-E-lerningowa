...
<div class="content">
	...
	<?php
		...
		echo "NOWA LEKCJA:<br><br>";
		
		echo "<form method='post' action='lekcjaaddscript.php' enctype='multipart/form-data'>
			Nazwa lekcji:&nbsp;<input type='text' name='nazwa' maxlength='50' size='100'><br>
			<br><hr>
			<script type='text/javascript' src='/ckeditor/ckeditor.js'></script>
			<textarea name='tekst' id='edytor'></textarea>	
			<hr><br>
