...
<div class="content">
	...
	<?php
		...
		echo "<form method='post' action='pytanieadd.php?idt=$idt' enctype='multipart/form-data'>
			...
			Odpowiedź a:<input type='text' name='odp_a' maxlength='200' size='100'> <label><input type='checkbox' class='checkbox' value='1' name='apoprawna' />odp. a poprawna</label><br>
			Odpowiedź b:<input type='text' name='odp_b' maxlength='200' size='100'> <label><input type='checkbox' class='checkbox' value='1' name='bpoprawna' />odp. b poprawna</label><br>
			Odpowiedź c:<input type='text' name='odp_c' maxlength='200' size='100'> <label><input type='checkbox' class='checkbox' value='1' name='cpoprawna' />odp. c poprawna</label><br>
			Odpowiedź d:<input type='text' name='odp_d' maxlength='200' size='100'> <label><input type='checkbox' class='checkbox' value='1' name='dpoprawna' />odp. d poprawna</label><br>
