...
<div class="content">
	...
	<?php
		...
		foreach($pytania as $row){
			...
			echo "<br><label><input type='checkbox' class='checkbox' value='a' name='$idp' />a. " . $odp_a . "</label>";
			echo "<br><label><input type='checkbox' class='checkbox' value='b' name='$idp' />b. " . $odp_b . "</label>";
			echo "<br><label><input type='checkbox' class='checkbox' value='c' name='$idp' />c. " . $odp_c . "</label>";
			echo "<br><label><input type='checkbox' class='checkbox' value='d' name='$idp' />d. " . $odp_d . "</label>";
		}
